...
public class FuelListenerExample : FuelSDKListener {
	...
	public override void OnUserInfo(Dictionary<string,object> data) {

		m_fuelExample.OnUserInfo (data);

	}

	public override void OnUpdatedUserInfo(Dictionary<string,object> data) {

		m_fuelExample.OnUpdatedUserInfo (data);
		
	}

	public override void OnUserAvatars(Dictionary<string,object> avatars) {

		m_fuelExample.OnUserAvatars (avatars);
