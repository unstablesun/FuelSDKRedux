...
def addInit(contentOnly=False):
	...
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_VG_CONSUME_SUCCESS object:nil];'
	...
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_IGNITE_JOIN_EVENT object:nil];'
	...
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_IGNITE_SAMPLE_EVENTS object:nil];'
	...
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_IGNITE_OFFER object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_IGNITE_ACCEPT_OFFER object:nil];'
	...
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_LOCALIZATION_LOADED object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_RECEIVE_DATA object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_USER_INFO object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_USER_INFO_UPDATED object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_USER_AVATARS object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_IGNITE_ENGINE_LOADED object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_DYNAMICS_ENGINE_LOADED object:nil];'
	print '\t\t[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveLocalNotification:) name:FSDK_BROADCAST_SERVER_API_STATUS_UPDATED object:nil];'
...
def addEnterBackground(contentOnly=False):
	...
	print '\t[fuel cancelAllNotifications];'
...
def addExtraFunctions():
	...
	print ''
	print '\t\tmessage = [NSString stringWithFormat:@"{'+'\\'+'"action'+'\\'+'": '+'\\'+'"%s'+'\\'+'" , '+'\\'+'"data'+'\\'+'" : %@}", [type UTF8String], paramsString];'
	print '\t} else {'
